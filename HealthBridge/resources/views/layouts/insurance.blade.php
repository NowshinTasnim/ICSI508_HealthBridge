...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/lab_insurance.css') }}">
</head>
...
{{--                        <!-- Go to Profile page-->--}}
{{--                        <a href="#"><img src="{{ asset('images/icon1.png') }}" alt="Insurance Company"></a>--}}
...
<nav class="bg-white shadow-lg">
    <div class="head_part">
        <div class="flex justify-between items-center py-4">
            ...
            <!-- Search and User Info -->
            <div class="rightdiv flex items-center space-x-6">
{{--                <!-- Search -->--}}
{{--                <div class="relative flex items-center">--}}
{{--                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">--}}
{{--                        <button class="p-2">--}}
...
{{--                </div>--}}
                ...
                <div class="relative">
                    ...
                    <div class="flex flex-col items-center pointer-events-auto">
                        <!-- Go to Profile page-->
                        <a href="{{ route('Insurance.profile') }}"><img src="{{ asset('images/icon1.png') }}" alt="Insurance"></a>
                        <span class="text-sm text-gray-700">{{$log}}</span>
                    </div>
...
<div class="flex min-h-screen">
    ...
    <div class="w-64 bg-purple-800 text-white">
        <!-- Dashboard Link -->
        <a href="{{ route('Insurance.dashboard') }}"
           class="flex items-center space-x-2 px-4 py-4 {{ request()->routeIs('Insurance.dashboard') ? 'bg-purple-900' : 'hover:bg-purple-700' }}">
